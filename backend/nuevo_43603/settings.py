"""
Django settings for nuevo_43603 project.
...
WSGI_APPLICATION = 'nuevo_43603.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nuevo_43603 API",
    "DESCRIPTION": "API documentation for nuevo_43603 App",
    "VERSION": "v1",
}
